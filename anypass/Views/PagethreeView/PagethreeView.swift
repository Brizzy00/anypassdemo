...
struct PagethreeView: View {
    @StateObject var pagethreeViewModel = PagethreeViewModel()
            ...
            VStack {
                VStack(alignment: .leading, spacing: 0) {
                    ...
                    ZStack(alignment: .topLeading) {
                        Image("img_13")
                            .resizable()
                            .frame(width: getRelativeWidth(412.0), height: getRelativeHeight(315.0),
                                   alignment: .center)
                            .scaledToFit()
                            .clipped()
                            .padding(.bottom, getRelativeHeight(382.0))
                            .onTapGesture {
                                pagethreeViewModel.nextScreen = "PagefourView"
                            }
                        Text(StringConstants.kLbl20240209)
                            .font(FontScheme.kInterSemiBold(size: getRelativeHeight(15.0)))
                            .fontWeight(.semibold)
                            .foregroundColor(ColorConstants.WhiteA700)
                            .minimumScaleFactor(0.5)
                            .multilineTextAlignment(.leading)
                            .frame(width: getRelativeWidth(89.0), height: getRelativeHeight(19.0),
                                   alignment: .topLeading)
                            .padding(.bottom, getRelativeHeight(622.39))
                ...
                Group {
                    NavigationLink(destination: PagefourView(),
                                   tag: "PagefourView",
                                   selection: $pagethreeViewModel.nextScreen,
                                   label: {
                                       EmptyView()
                                   })
                }
